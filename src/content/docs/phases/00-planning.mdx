...
>[!error] EVEN MORE IMPORTANT
>Don't forget friends and family. Stop putting everything into this. Give back to those that give to you again.
...
```bash
sqlite3 /srv/sonarr/config/sonarr.db "VACUUM INTO '$HOME/wl-dump/sonarr-main.db'"
sqlite3 /srv/sonarr/config/logs.db   "VACUUM INTO '$HOME/wl-dump/sonarr-log.db'"
```
